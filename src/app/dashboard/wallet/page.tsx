    ...
    <div className="flex flex-col gap-6">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          ...
          <BalanceCard label={t("dashboardHome.gameRewardUsdt")} value={isLoading ? "…" : fmtUsdt(balances?.gameRewardUsdt ?? 0)} hint={t("wallet.gameRewardLockedHint")} />
          <BalanceCard label={t("dashboardHome.referralUsdt")} value={isLoading ? "…" : fmtUsdt(balances?.referralUsdt ?? 0)} tone="mint" hint={t("wallet.withdrawableHint")} />
          <BalanceCard label={t("wallet.recycledUsdtLabel")} value={isLoading ? "…" : fmtUsdt(balances?.recycledUsdt ?? 0)} tone="mint" hint={t("wallet.withdrawableHint")} />
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          ...
          <BalanceCard label={t("dashboardHome.availableDoge")} value={isLoading ? "…" : fmtDoge(balances?.availableDoge ?? 0)} hint={t("wallet.availableDogeConvertHint")} />
